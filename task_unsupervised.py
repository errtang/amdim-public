...
def _train(model, optim_inf, scheduler_inf, checkpointer, epochs,
    ...
    for epoch in range(next_epoch, epochs):
        ...
        for _, ((images1, images2), _) in enumerate(train_loader):
            ...
            # TODO: update model to generate classifiers on separate dataset
            ...
            # TODO: calculate classifier loss on separate dataset
            ...
            # TODO: update train accuracies on separate dataset
...
def train_unsupervised(model, learning_rate, dataset, train_loader,
